    ...
    App.prototype = {
      init: function() {
        ...
        connectWebViewJavascriptBridge(function(bridge) {
          ...
          //首次加载时调用接口
          bridge.callHandler('goLoadPageHandler',{'title':'红包拼手气，新年福禄齐','href':'','icon':2,'backBtn':1}, function(responseData) {
          ...
          $(document).on('click', '#rule', function(){
            bridge.callHandler('goPageHandler',{'title': '活动规则','icon':0,'backBtn':0}, function(responseData) {
              if(typeof responseData=="string")responseData = JSON.parse(responseData);
              if(responseData.result) location.href = webUrl + "/view/2018/market/redPacket/rule.html?userId="+userId;
            });
          });
          ...
          $(document).on('click', '#goShareBtn', function(){
            ...
            if(userId == ""){//未登录
              //分享信息
              sendInfo = {
                'shareTitle': '开年抢红包，看谁手气好！',
                'shareLink': webUrl +'/view/2018/market/redPacket/index.html?type=h5',
                'shareIntro':'无门槛红包等你来，钱保姆祝您2018一旺到底！',
                'shareIcon': pcCdnUrl+'/images/shareIcon/20170517.png'
              }
      ...
      outSiteFun: function(){
        ...
        if(pageType == "h5"){
          ...
          $("#rule").on("click",function(){
            location.href = webUrl + "/view/2018/market/redPacket/rule.html";
          });
