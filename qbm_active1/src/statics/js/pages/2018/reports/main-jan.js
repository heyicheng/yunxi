                ...
                series: [
                    {
                        ...
                        center: ['50%', '60%'],
                        data: [
                                {value: 41.60, name: '网宝强'},
                                {value: 10.88, name: '网益宝'},
                                {value: 10.19, name: '新手专享'},
                                {value: 10.04, name: '假日宝'},
                                {value: 0.72, name: '其他'},
                                {value: 0.01, name: '车贷'}
                        ],
                        startAngle: 89,
                ...
                series: [
                    {
                        ...
                        startAngle: 88,
                        data: [
                            {value: 56.27, name: '1万以下'},
                            {value: 37.60, name: '1万-5万'},
                            {value: 4.38, name: '5万-10万'},
                            {value: 1.76, name: '10万及以上'}
                        ],
                        label: {
                            normal: {
                                show: true,
        ...
        chartFemaleArea: function () {//page5
            ...
            var option = {
                ...
                series: [{
                    ...
                    top: 100,
                    data: [
                        {name: '北京', value: 3637262.13},
                        {name: '天津', value: 2425407.00},
                        {name: '上海', value: 8644951.69},
                        {name: '重庆', value: 1679518.66},
                        {name: '河北', value: 4601792.35},
                        {name: '河南', value: 5385936.79},
                        {name: '云南', value: 748922.01},
                        {name: '辽宁', value: 3293813.72},
                        {name: '黑龙江', value: 2581705.78},
                        {name: '湖南', value: 6310558.41},
                        {name: '安徽', value: 8671242.71},
                        {name: '山东', value: 9792584.76},
                        {name: '新疆', value: 3785178.21},
                        {name: '江苏', value: 12757840.18},
                        {name: '浙江', value: 108733089.70},
                        {name: '江西', value: 8995751.93},
                        {name: '湖北', value: 9329330.18},
                        {name: '广西', value: 1657120.87},
                        {name: '甘肃', value: 1064835.07},
                        {name: '山西', value: 3697254.55},
                        {name: '内蒙古', value: 1543795.02},
                        {name: '陕西', value: 4125789.93},
                        {name: '吉林', value: 1975012.54},
                        {name: '福建', value: 5043177.68},
                        {name: '贵州', value: 516910.68},
                        {name: '广东', value: 4724447.22},
                        {name: '青海', value: 1512753.97},
                        {name: '西藏', value: 0.00},
                        {name: '四川', value: 8752640.01},
                        {name: '宁夏', value: 2751769.50},
                        {name: '海南', value: 340303.26},
                        {name: '台湾', value: 0.00},
                        {name: '香港', value: 0.00},
                        {name: '澳门', value: 0.00}
                    ],
