                ...
                series: [
                    {
                        ...
                        center: ['50%', '60%'],
                        data: [
                                {value: 45.10, name: '网宝强'},
                                {value: 19.99, name: '网益宝'},
                                {value: 21.50, name: '新手专享'},
                                {value: 12.77, name: '假日宝'},
                                {value: 0.64, name: '其他'}
                        ],
                        startAngle: 89,
                        label: {
                ...
                series: [
                    {
                        ...
                        startAngle: 88,
                        data: [
                            {value: 50.08, name: '1万以下'},
                            {value: 40.08, name: '1万-5万'},
                            {value: 7.21, name: '5万-10万'},
                            {value: 2.63, name: '10万及以上'}
                        ],
                        label: {
                            normal: {
                                show: true,
        ...
        chartFemaleArea: function () {//page5
            ...
            var option = {
                ...
                series: [{
                    ...
                    top: 100,
                    data: [
                        {name: '北京', value: 3634734.05},
                        {name: '天津', value: 4516634.18},
                        {name: '上海', value: 8095528.75},
                        {name: '重庆', value: 1593347.71},
                        {name: '河北', value: 7292950.32},
                        {name: '河南', value: 6417923.83},
                        {name: '云南', value: 1571355.44},
                        {name: '辽宁', value: 5661758.14},
                        {name: '黑龙江', value: 3642605.70},
                        {name: '湖南', value: 6103459.25},
                        {name: '安徽', value: 10183536.72},
                        {name: '山东', value: 11705700.88},
                        {name: '新疆', value: 3131554.28},
                        {name: '江苏', value: 16860519.35},
                        {name: '浙江', value: 118464460.77},
                        {name: '江西', value: 8665195.46},
                        {name: '湖北', value: 10629307.22},
                        {name: '广西', value: 1483111.20},
                        {name: '甘肃', value: 1401495.58},
                        {name: '山西', value: 4341274.66},
                        {name: '内蒙古', value: 1725075.47},
                        {name: '陕西', value: 5814257.48},
                        {name: '吉林', value: 3103758.15},
                        {name: '福建', value: 4744582.48},
                        {name: '贵州', value: 967750.21},
                        {name: '广东', value: 5406180.36},
                        {name: '青海', value: 1132224.67},
                        {name: '西藏', value: 0.00},
                        {name: '四川', value: 10507937.38},
                        {name: '宁夏', value: 685214.16},
                        {name: '海南', value: 474874.89},
                        {name: '台湾', value: 0.00},
                        {name: '香港', value: 0.00},
                        {name: '澳门', value: 0.00}
                    ],
