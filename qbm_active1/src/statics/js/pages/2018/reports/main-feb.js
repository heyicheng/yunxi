                ...
                series: [
                    {
                        ...
                        center: ['50%', '60%'],
                        data: [
                                {value: 61.22, name: '网宝强'},
                                {value: 9.95, name: '网益宝'},
                                {value: 19.45, name: '新手专享'},
                                {value: 8.67, name: '假日宝'},
                                {value: 0.71, name: '其他'},
                                {value: 0.01, name: '车贷'}
                        ],
                ...
                series: [
                    {
                        ...
                        startAngle: 88,
                        data: [
                            {value: 45.67, name: '1万以下'},
                            {value: 44.44, name: '1万-5万'},
                            {value: 7.10, name: '5万-10万'},
                            {value: 2.79, name: '10万及以上'}
                        ],
                        label: {
                            normal: {
                                show: true,
        ...
        chartFemaleArea: function () {//page5
            ...
            var option = {
                ...
                series: [{
                    ...
                    top: 100,
                    data: [
                        {name: '北京', value: 3691130.44},
                        {name: '天津', value: 1936739.65},
                        {name: '上海', value: 7279105.33},
                        {name: '重庆', value: 1192698.89},
                        {name: '河北', value: 5429548.28},
                        {name: '河南', value: 5401519.65},
                        {name: '云南', value: 634659.70},
                        {name: '辽宁', value: 3304965.19},
                        {name: '黑龙江', value: 3407951.46},
                        {name: '湖南', value: 6131424.34},
                        {name: '安徽', value: 9754584.32},
                        {name: '山东', value: 10475353.35},
                        {name: '新疆', value: 3229657.44},
                        {name: '江苏', value: 15058888.35},
                        {name: '浙江', value: 115385098.65},
                        {name: '江西', value: 8874884.36},
                        {name: '湖北', value: 10489169.27},
                        {name: '广西', value: 1560371.76},
                        {name: '甘肃', value: 1224754.74},
                        {name: '山西', value: 3756427.59},
                        {name: '内蒙古', value: 817221.69},
                        {name: '陕西', value: 5086269.73},
                        {name: '吉林', value: 2047282.59},
                        {name: '福建', value: 4298436.86},
                        {name: '贵州', value: 587264.36},
                        {name: '广东', value: 5313422.68},
                        {name: '青海', value: 300426.77},
                        {name: '西藏', value: 0.00},
                        {name: '四川', value: 7554223.81},
                        {name: '宁夏', value: 2427258.98},
                        {name: '海南', value: 509030.35},
                        {name: '台湾', value: 0.00},
                        {name: '香港', value: 0.00},
                        {name: '澳门', value: 0.00}
                    ],
