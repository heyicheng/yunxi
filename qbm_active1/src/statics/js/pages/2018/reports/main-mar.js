                ...
                series: [
                    {
                        ...
                        center: ['50%', '60%'],
                        data: [
                                {value: 59.61, name: '网宝强'},
                                {value: 13.08, name: '网益宝'},
                                {value: 15.85, name: '新手专享'},
                                {value: 11.43, name: '假日宝'},
                                {value: 0.03, name: '其他'}
                        ],
                        startAngle: 89,
                        label: {
                ...
                series: [
                    {
                        ...
                        startAngle: 88,
                        data: [
                            {value: 44.57, name: '1万以下'},
                            {value: 46.26, name: '1万-5万'},
                            {value: 6.03, name: '5万-10万'},
                            {value: 3.14, name: '10万及以上'}
                        ],
                        label: {
                            normal: {
                                show: true,
        ...
        chartFemaleArea: function () {//page5
            ...
            var option = {
                ...
                series: [{
                    ...
                    top: 100,
                    data: [
                        {name: '北京', value: 7752306.42},
                        {name: '天津', value: 4893425.67},
                        {name: '上海', value: 13475992.63},
                        {name: '重庆', value: 2224938.66},
                        {name: '河北', value: 8265268.16},
                        {name: '河南', value: 8769891.09},
                        {name: '云南', value: 1377089.29},
                        {name: '辽宁', value: 5639805.82},
                        {name: '黑龙江', value: 4515296.98},
                        {name: '湖南', value: 10095426.01},
                        {name: '安徽', value: 16458939.11},
                        {name: '山东', value: 15481233.04},
                        {name: '新疆', value: 6644793.62},
                        {name: '江苏', value: 24399830.64},
                        {name: '浙江', value: 196886256.59},
                        {name: '江西', value: 13548496.59},
                        {name: '湖北', value: 15518471.27},
                        {name: '广西', value: 2448939.84},
                        {name: '甘肃', value: 2016469.50},
                        {name: '山西', value: 5893258.34},
                        {name: '内蒙古', value: 1869376.24},
                        {name: '陕西', value: 9194021.72},
                        {name: '吉林', value: 3561395.26},
                        {name: '福建', value: 7204274.82},
                        {name: '贵州', value: 1268384.44},
                        {name: '广东', value: 7865350.56},
                        {name: '青海', value: 2104402.37},
                        {name: '西藏', value: 0.00},
                        {name: '四川', value: 15761839.97},
                        {name: '宁夏', value: 3818725.22},
                        {name: '海南', value: 348802.74},
                        {name: '台湾', value: 0.00},
                        {name: '香港', value: 0.00},
                        {name: '澳门', value: 0.00}
                    ],
