			...
			App.prototype={
					...
					connectWebViewJavascriptBridge(function(bridge) {
						...
						$(document).on('click',"#rule",function(){
							bridge.callHandler('goPageHandler',{'title': '活动规则','icon':0,'backBtn':0}, function(responseData) {
				              ...
				              if(responseData.result) location.href = webUrl +  "/view/2018/jiaribao/rule.html?interaction=1&userId=" + userId;
				            });
						});
				...
				outSite: function(){
					...
					if(self.url.type != "" || self.url.type != null){
						//活动规则
						$(document).on("click","#rule",function(){
							location.href = webUrl + '/view/2018/jiaribao/rule.html';
						});
					}
