                ...
                series: [
                    {
                        ...
                        center: ['50%', '60%'],
                        data: [
								{value: 42.72, name: '网宝强'},
								{value: 15.12, name: '网益宝'},
								{value: 17.90, name: '新手专享'},
								{value: 20.58, name: '假日宝'},
								{value: 3.57, name: '其他'},
								{value: 0.11, name: '车贷'}
                        ],
                        startAngle: 89,
                ...
                series: [
                    {
                        ...
                        startAngle: 88,
                        data: [
                            {value: 52.05, name: '1万以下'},
                            {value: 41.40, name: '1万-5万'},
                            {value: 4.75, name: '5万-10万'},
                            {value: 1.80, name: '10万及以上'}
                        ],
                        label: {
                            normal: {
                                show: true,
        ...
        chartFemaleArea: function () {//page5
            ...
            var option = {
                ...
                series: [{
                    ...
                    top: 100,
                    data: [
                        {name: '北京', value: 2409431.72},
                        {name: '天津', value: 1983870.70},
                        {name: '上海', value: 8373365.99},
                        {name: '重庆', value: 1333185.57},
                        {name: '河北', value: 4385883.47},
                        {name: '河南', value: 4853379.36},
                        {name: '云南', value: 816489.37},
                        {name: '辽宁', value: 2682636.28},
                        {name: '黑龙江', value: 3432669.55},
                        {name: '湖南', value: 6564327.09},
                        {name: '安徽', value: 7332874.93},
                        {name: '山东', value: 9297046.48},
                        {name: '新疆', value: 2241306.60},
                        {name: '江苏', value: 12804203.35},
                        {name: '浙江', value: 113942963.12},
                        {name: '江西', value: 12080488.11},
                        {name: '湖北', value: 8548253.64},
                        {name: '广西', value: 1619436.69},
                        {name: '甘肃', value: 843719.16},
                        {name: '山西', value: 3079079.95},
                        {name: '内蒙古', value: 761272.61},
                        {name: '陕西', value: 3959020.88},
                        {name: '吉林', value: 1975068.93},
                        {name: '福建', value: 3432126.98},
                        {name: '贵州', value: 656943.36},
                        {name: '广东', value: 3874936.95},
                        {name: '青海', value: 599223.25},
                        {name: '西藏', value: 0.00},
                        {name: '四川', value: 7727577.81},
                        {name: '宁夏', value: 926372.23},
                        {name: '海南', value: 185356.83},
                        {name: '台湾', value: 0.00},
                        {name: '香港', value: 0.00},
                        {name: '澳门', value: 0.00}
                    ],
