                ...
                series: [
                    {
                        ...
                        center: ['50%', '60%'],
                        data: [
                                {value: 53.09, name: '网宝强'},
                                {value: 14.28, name: '网益宝'},
                                {value: 13.97, name: '新手专享'},
                                {value: 6.37, name: '假日宝'},
                                {value: 4.48, name: '其他'},
                                {value: 0.04, name: '车贷'}
                        ],
                ...
                series: [
                    {
                        ...
                        startAngle: 88,
                        data: [
                            {value: 61.52, name: '1万以下'},
                            {value: 32.64, name: '1万-5万'},
                            {value: 4.00, name: '5万-10万'},
                            {value: 1.85, name: '10万及以上'}
                        ],
                        label: {
                            normal: {
                                show: true,
        ...
        chartFemaleArea: function () {//page5
            ...
            var option = {
                ...
                series: [{
                    ...
                    top: 100,
                    data: [
                        {name: '北京', value: 3145072.59},
                        {name: '天津', value: 2449071.74},
                        {name: '上海', value: 9177916.29},
                        {name: '重庆', value: 1506201.72},
                        {name: '河北', value: 5206702.66},
                        {name: '河南', value: 6166908.02},
                        {name: '云南', value: 864121.52},
                        {name: '辽宁', value: 4169432.44},
                        {name: '黑龙江', value: 3056014.74},
                        {name: '湖南', value: 6984322.07},
                        {name: '安徽', value: 10180639.10},
                        {name: '山东', value: 10512115.25},
                        {name: '新疆', value: 3346268.16},
                        {name: '江苏', value: 16132952.40},
                        {name: '浙江', value: 121218834.36},
                        {name: '江西', value: 9816744.23},
                        {name: '湖北', value: 9639803.98},
                        {name: '广西', value: 1976628.57},
                        {name: '甘肃', value: 973896.37},
                        {name: '山西', value: 3601988.51},
                        {name: '内蒙古', value: 1896444.93},
                        {name: '陕西', value: 4676515.15},
                        {name: '吉林', value: 1990942.81},
                        {name: '福建', value: 3997552.25},
                        {name: '贵州', value: 498385.11},
                        {name: '广东', value: 4526221.11},
                        {name: '青海', value: 1395807.15},
                        {name: '西藏', value: 0.00},
                        {name: '四川', value: 10116442.51},
                        {name: '宁夏', value: 2300785.58},
                        {name: '海南', value: 255055.59},
                        {name: '台湾', value: 0.00},
                        {name: '香港', value: 0.00},
                        {name: '澳门', value: 0.00}
                    ],
