(function () {
    ...
    var dataReport = {
        ...
        totalInvestCountChart: function () {//第9页-第一个图
		...
		totalInvestCountChart2: function () {//第10页-第一个图
        ...
        //累计为用户赚取
		totalUserInvestProfitChart2: function () {//第10页-第二个图
                ...
                series: [
                    {
                        ...
                        center: ['50%', '60%'],
                        data: [
													{value: 37.84, name: '网宝强'},
													{value: 14.61, name: '网易宝'},
													{value: 26.99, name: '新手专享'},
													{value: 17.76, name: '假日宝'},
													{value: 2.77, name: '其他'},
													{value: 0.11, name: '车贷'}
                        ],
                        startAngle: 89,
        ...
        chartFemalePeriod: function () {//page04
                ...
                series: [
                    {
                        ...
                        startAngle: 88,
                        data: [
                            {value: 55.38, name: '1万以下'},
                            {value: 39.04, name: '1万-5万'},
                            {value: 3.91, name: '5万-10万'},
                            {value: 1.67, name: '10万及以上'}
                        ],
                        label: {
                            normal: {
                                show: true,
        ...
        chartFemaleArea: function () {
            ...
            var option = {
                ...
                series: [{
                    ...
                    top: 100,
                    data: [
                        {name: '北京', value: 3037078.20},
                        {name: '天津', value: 2364970.99},
                        {name: '上海', value: 9016957.01},
                        {name: '重庆', value: 1242590.6},
                        {name: '河北', value: 6107194.61},
                        {name: '河南', value: 6034327.7},
                        {name: '云南', value: 907477.16},
                        {name: '辽宁', value: 4127914.36},
                        {name: '黑龙江', value: 3173871.69},
                        {name: '湖南', value: 7448078.55},
                        {name: '安徽', value: 8531755.74},
                        {name: '山东', value: 12580467.04},
                        {name: '新疆', value: 2857331.13},
                        {name: '江苏', value: 15148219.73},
                        {name: '浙江', value: 126558856.56},
                        {name: '江西', value: 10166127.29},
                        {name: '湖北', value: 12453587.54},
                        {name: '广西', value: 2480517.13},
                        {name: '甘肃', value: 1413108.04},
                        {name: '山西', value: 3928050.07},
                        {name: '内蒙古', value: 1544428.21},
                        {name: '陕西', value: 4309874.87},
                        {name: '吉林', value: 2222149.84},
                        {name: '福建', value: 4297347.33},
                        {name: '贵州', value: 688572.49},
                        {name: '广东', value: 5398645.32},
                        {name: '青海', value: 332043.16},
                        {name: '西藏', value: 0.00},
                        {name: '四川', value: 9628053.99},
                        {name: '宁夏', value: 2801311.8},
                        {name: '海南', value: 310994.14},
                        {name: '台湾', value: 0.0},
                        {name: '香港', value: 0.0},
                        {name: '澳门', value: 0.0}
                    ],
