                ...
                series: [
                    {
                        ...
                        center: ['50%', '60%'],
                        data: [
                                {value: 45.54, name: '网宝强'},
                                {value: 19.66, name: '网益宝'},
                                {value: 19.17, name: '新手专享'},
                                {value: 10.15, name: '假日宝'},
                                {value: 3.47, name: '其他'},
                                {value: 0.04, name: '车贷'}
                        ],
                        startAngle: 89,
                ...
                series: [
                    {
                        ...
                        startAngle: 88,
                        data: [
                            {value: 59.68, name: '1万以下'},
                            {value: 36.98, name: '1万-5万'},
                            {value: 2.65, name: '5万-10万'},
                            {value: 0.69, name: '10万及以上'}
                        ],
                        label: {
                            normal: {
                                show: true,
        ...
        chartFemaleArea: function () {//page5
            ...
            var option = {
                ...
                series: [{
                    ...
                    top: 100,
                    data: [
                        {name: '北京', value: 1858439.20},
                        {name: '天津', value: 2362176.09},
                        {name: '上海', value: 8835448.37},
                        {name: '重庆', value: 1115125.50},
                        {name: '河北', value: 3923675.15},
                        {name: '河南', value: 4856765.55},
                        {name: '云南', value: 657014.26},
                        {name: '辽宁', value: 2701689.72},
                        {name: '黑龙江', value: 2839546.10},
                        {name: '湖南', value: 4465308.49},
                        {name: '安徽', value: 8110473.52},
                        {name: '山东', value: 9955497.19},
                        {name: '新疆', value: 2808761.41},
                        {name: '江苏', value: 11750022.86},
                        {name: '浙江', value: 147925736.84},
                        {name: '江西', value: 8577364.68},
                        {name: '湖北', value: 8561968.64},
                        {name: '广西', value: 1609512.69},
                        {name: '甘肃', value: 1157995.87},
                        {name: '山西', value: 3263606.87},
                        {name: '内蒙古', value: 1221800.64},
                        {name: '陕西', value: 3879551.05},
                        {name: '吉林', value: 1994002.34},
                        {name: '福建', value: 3073232.24},
                        {name: '贵州', value: 426502.28},
                        {name: '广东', value: 3512494.79},
                        {name: '青海', value: 741023.18},
                        {name: '西藏', value: 0.00},
                        {name: '四川', value: 8805347.13},
                        {name: '宁夏', value: 1752338.05},
                        {name: '海南', value: 345430.51},
                        {name: '台湾', value: 0.00},
                        {name: '香港', value: 0.00},
                        {name: '澳门', value: 0.00}
                    ],
